...
export class Scene_210 extends BaseScene {
    private sleepEffectRemainSeconds: number = 0;

    public getPreviousScene(): number { return 209; }

    public getNextScene(): number { return 211; }
